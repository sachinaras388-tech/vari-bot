...
WAKE_WORD = getattr(settings, "MYARA_WAKE_WORD", "myara") or "myara"
...
def build_help_text() -> str:
    """Create the WhatsApp help text for the Myara assistant."""
    return (
        "Myara commands:\n"
...
def build_command_help(command: str) -> str:
    ...
    command_map = {
        ...
        "about": "Myara is your AI WhatsApp assistant with memory, commands, and admin controls.",
        "menu": "Show the main command menu for Myara.",
        ...
        "ai": "Start a conversational AI reply using Myara's memory.",
        ...
        "explain": "Ask Myara to explain a topic in simple words.",
        "chat": "Continue the conversation naturally with Myara.",
    }
